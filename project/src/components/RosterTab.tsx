  ...
  return (
    <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {meeting.status === 'Planned' && (
                      <>
                        ...
                        <Button size="sm" variant="outline" className="h-7 text-xs" onClick={() => { setSuggestionsMeeting(meeting); setSuggestionsHighlightRole(null) }}>
      ...
      <SuggestionsDrawer
        ...
        highlightRole={suggestionsHighlightRole}
        onClose={() => { setSuggestionsMeeting(null); setSuggestionsHighlightRole(null) }}
